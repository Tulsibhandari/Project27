...
function setup() {
	...
	rope1= new rope(bobObject1.body,support.body,-120,10);
    rope2= new rope(bobObject2.body,support.body,-4*13,10);
	rope3= new rope(bobObject3.body,support.body,10,10);
	rope4= new rope(bobObject4.body,support.body,4*17,10);
    rope5= new rope(bobObject5.body,support.body,130,10);
